...
<a href="https://github.com/primitiv0/Proxmox/blob/main/LICENSE"><img src="https://badgen.net/github/license/primitiv0/Proxmox" ></a> <a href="https://primitiv0.github.io/Proxmox/"><img src="https://badgen.net/github/checks/primitiv0/Proxmox/main/"></a> <a href="https://github.com/primitiv0/Proxmox/discussions"><img src="https://github.com/primitiv0/Proxmox/blob/main/misc/images/discussions.png?raw=true" height="21" /></a> <a href="https://github.com/primitiv0/Proxmox/blob/main/CHANGELOG.MD"><img src="https://github.com/primitiv0/Proxmox/blob/main/misc/images/change.png?raw=true" height="21" /></a>🔸
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/post-install-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/kernel-clean-v3.sh)"
```
____________________________________________________________________________________________ 
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/edge-kernel.sh)"
```
____________________________________________________________________________________________ 
...
<p align="center"><img src="https://github.com/primitiv0/Proxmox/blob/main/misc/images/cpu.png?raw=true" height="100"/></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/scaling-governor.sh)"
```
____________________________________________________________________________________________ 
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/update-lxcs.sh)"
```
____________________________________________________________________________________________ 
...
<p align="center"><img src="https://github.com/primitiv0/Proxmox/blob/main/misc/images/haos.png?raw=true"/></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/vm/haos-vm-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/homeassistant-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/ha-copy-data.sh)"
 ```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/usb-passthrough.sh)" -s 106
```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/hacs.sh)"
```
After install, reboot Home Assistant and **clear browser cache** then Add HACS integration.


⚙️ [**Update Menu**](https://raw.githubusercontent.com/primitiv0/Proxmox/main/misc/images/update-menu.png)
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/podman-homeassistant-v3.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  2GB RAM - 16GB Storage - 2vCPU ⚡</h3>
...
Run in the Proxmox Shell
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/ha-copy-data-podman.sh)"
 ```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/podman_hacs.sh)"
```
After install, reboot Home Assistant and **clear browser cache** then Add HACS integration.
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/iobroker-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/openhab-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/homebridge-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/esphome-v3.sh)"
```
...
```yaml
 bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/nginx-proxy-manager-v3.sh)"
```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/npm_update.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/mqtt-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/node-red-v3.sh)"
```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/node-red-themes.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/n8n-v3.sh)"
```
...
<p align="center"><img src="https://mariadb.com/wp-content/webp-express/webp-images/doc-root/wp-content/themes/sage/dist/images/mariadb-logo-white.png.webp" alt="MariaDB"/><img src="https://raw.githubusercontent.com/primitiv0/Proxmox/main/misc/images/adminer_logo-cl.png" height="60"></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/mariadb-v3.sh)"
```
...
apt update && apt upgrade -y
```
⚙️ [**Adminer**](https://raw.githubusercontent.com/primitiv0/Proxmox/main/misc/images/adminer.png) (formerly phpMinAdmin) is a full-featured database management tool
...
<p align="center"><img src="https://wiki.postgresql.org/images/3/30/PostgreSQL_logo.3colors.120x120.png" height="100"/><img src="https://raw.githubusercontent.com/primitiv0/Proxmox/main/misc/images/adminer_logo-cl.png" height="60"></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/postgresql-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/zigbee2mqtt-v3.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  1GB RAM - 4GB Storage - 2vCPU ⚡</h3>
...
Run in the Proxmox Shell
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/z2m-copy-data.sh)"
 ```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/deconz-v3.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  1GB RAM - 4GB Storage - 2vCPU ⚡</h3>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/zwavejs2mqtt-v3.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  1GB RAM - 4GB Storage - 2vCPU ⚡</h3>
...
Run in the Proxmox Shell
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/zwave-copy-data.sh)"
 ```
⚙️ **To Update Zwavejs2MQTT**

Run in the LXC Console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/zwavejs2mqtt-update.sh)"
```
...
<p align="center"><img src="https://github.com/primitiv0/Proxmox/blob/main/misc/images/nocodb.png?raw=true" height="100"/></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/nocodb-v3.sh)"
```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/nocodb-update.sh)"
```
...
<p align="center"><img src="https://github.com/primitiv0/Proxmox/blob/main/misc/images/prome.png?raw=true" height="100"/></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/prometheus-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/influxdb-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/grafana-v3.sh)"
```
...
<p align="center"><img src="https://raw.githubusercontent.com/primitiv0/Proxmox/main/misc/images/docker.png" height="100"/></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/docker-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/debian-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/ubuntu-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/unifi-v3.sh)"
```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/unifi-update.sh)"
```
____________________________________________________________________________________________ 
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/omada-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/meshcentral-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/plex-v3.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  2GB RAM - 8GB Storage - 2vCPU ⚡</h3>
...
Run in the Proxmox Shell
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/pms-copy-data.sh)"
 ```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/jellyfin-v3.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  2GB RAM - 8GB Storage - 2vCPU ⚡</h3>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/pihole-v3.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  512MiB RAM - 2GB Storage - 1vCPU ⚡</h3>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/technitiumdns-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/technitiumdns-update.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/adguard-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/uptimekuma-v3.sh)"
```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/uptimekuma-update.sh)"
```
____________________________________________________________________________________________ 
...
<p align="center"><img src="https://github.com/primitiv0/Proxmox/blob/main/misc/images/whoogle.png?raw=true" height="100"/></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/whoogle-v3.sh)"
```
...
<p align="center"><img src="https://github.com/primitiv0/Proxmox/blob/main/misc/images/heimdall.png?raw=true" height="100"/></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/heimdalldashboard-v3.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  512MiB RAM - 2GB Storage - 1vCPU ⚡</h3>
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/heimdalldashboard-all-update.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/dashy-v3.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  2GB RAM - 3GB Storage - 2vCPU ⚡</h3>
...
Run in the LXC Console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/dashy-update.sh)"
```
...
```
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/grocy-v3.sh)"
```
...
```
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/magicmirror-v3.sh)"
```
...
<p align="center"><img src="https://github.com/primitiv0/Proxmox/blob/main/misc/images/photoprism.png?raw=true" height="100"/></p>
...
```
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/photoprism-v3.sh)"
```
...
Run in the LXC Console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/photoprism-update.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/daemonsync-v3.sh)"
```
...
```
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/motioneye-v3.sh)"
```
...
<p align="center"><img src="https://github.com/primitiv0/Proxmox/blob/main/misc/images/filebrowser.png?raw=true" height="100"/></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/filebrowser-v3.sh)"
```
...
To Install Webmin System Administration [(Screenshot)](https://raw.githubusercontent.com/primitiv0/Proxmox/main/misc/images/file-manager.png), ⚠️ run the following in the LXC console.

```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/webmin.sh)"
```
...
```
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/wireguard-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/add-tailscale-lxc.sh)" -s 106
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/crowdsec-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/keycloak-v3.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/ct/vaultwarden-v3.sh)"
```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/vaultwarden-update.sh)"
```
⚙️ **To Update Web-vault (any)**

Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/primitiv0/Proxmox/raw/main/misc/web-vault-update.sh)"
```
